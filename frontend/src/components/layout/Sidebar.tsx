...
import { Inbox, BarChart3, Bot, Radio, Users, UserCircle, Settings, LogOut, MessageSquare, Menu, X } from "lucide-react";
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Mobile Top Bar */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-gray-200 px-4 py-2.5 flex items-center justify-between">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 px-2 py-1 safe-area-bottom">
